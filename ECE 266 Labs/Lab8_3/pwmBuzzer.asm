...
BUZZER_PIN_UNI  .field 	GPIO_PC4_WT0CCP0
...
buzzerInit      PUSH 	{LR}
				...
				LDR   	r0, BUZZER_GPIO
                BL    	SysCtlPeripheralEnable		; GOOD
				...
				LDR 	r0, BUZZER_BASE
				MOV 	r1, #BUZZER_PIN
				BL		GPIOPinTypeTimer		; GOOD

				LDR 	r0, BUZZER_PIN_UNI
				BL		GPIOPinConfigure		; GOOD

				;	Time configuring
				LDR		r0, BUZZER_TIME
				MOV 	r1, #TIMER_CFG_SPLIT_PAIR
				ORR 	r1, #TIMER_CFG_A_PWM
				BL 		TimerConfigure		; GOOD
...
buzzerOn	   	PUSH  	{r0, r1, LR}		; save return address
